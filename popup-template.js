...
<div id="popup" style="background: #333; padding: 16px; border-radius: 8px; height: 400px; width: 300px; display: flex; flex-direction: column; position: fixed; top: 20px; left: 20px;">
  <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 12px;">
    <div style="font-size: 16px; font-weight: bold; color: #fff;">Element Detective</div>
    <div style="display: flex; gap: 8px;">
      <!-- Pin Icon Button -->
      <button style="background: none; border: none; cursor: pointer;" onclick="toggleSidePanel()">
...
<script>
  // Function to toggle the side panel on and off
  function toggleSidePanel() {
    const popup = document.getElementById("popup");
    popup.classList.toggle("sidePanel");
  ...
  function hidePopup() {
    const popup = document.getElementById("popup");
    popup.style.display = 'none'; // or hide the popup however you like
  }
</script>
